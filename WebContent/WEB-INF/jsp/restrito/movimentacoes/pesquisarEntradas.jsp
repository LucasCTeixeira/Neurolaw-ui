...
function pesquisar(form){
	location.href='${pageContext.servletConfig.servletContext.contextPath}/entradas/pesquisar?inicio='+form.inicio.value+'&termino='+form.termino.value+'&filial='+form.filial.value+'&fornecedor='+form.fornecedor.value+'&produto='+form.produto.value;
} 
</script>
