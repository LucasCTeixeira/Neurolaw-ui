...
<body>
    ...
    <div class="page-header">
     	<h1><b>Detalhar Saida #<c:out value="${saida.key}"></c:out></b></h1>
    </div>
			...
			<thead align="left">
				<tr>
					...
					<td colspan="5" align="left" style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: gray">
						<c:out value="${saida.filial.nome}"></c:out>
					</td>
				</tr>
				<tr>
					<th colspan="1" align="left" style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: gray" width="10%">
					...
					<td colspan="5" align="left" style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: gray">
						<c:out value="${saida.usuario.nome}"></c:out>
					</td>
				</tr>
				<tr>
					<th colspan="1" align="left" style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: gray" width="10%">
					...
					<td colspan="5" align="left" style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: gray">
						<fmt:formatDate value="${saida.createDate}" type="both" pattern="dd/MM/yyyy HH:mm"/>
					</td>
				</tr>
				<tr>
			...
			<tfoot align="left">
				<tr>
					...
					<th colspan="1" align="left">
						<fmt:formatNumber type="currency" currencySymbol="R$" value="${saida.valorTotal}" minFractionDigits="2" maxFractionDigits="2"/>
					</th>
				</tr>
				<tr>
